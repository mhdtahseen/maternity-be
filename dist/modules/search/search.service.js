...
const timeline_event_entity_1 = require("../timeline/entities/timeline-event.entity");
let SearchService = class SearchService {
    constructor(documentRepository, timelineRepository) {
        this.documentRepository = documentRepository;
        this.timelineRepository = timelineRepository;
    }
    async searchDocuments(dto) {
...
exports.SearchService = SearchService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(timeline_event_entity_1.TimelineEvent)),
